...
export const AuthForm = () => {
	...
	const handleSubmit = (e) => {
		...
		if (authMode === "signin") {
			let url = "https://aw2022final.herokuapp.com/api/login?email=" + e.target.email.value + "&password=" + e.target.password.value
			...
			let url = "https://aw2022final.herokuapp.com/api/register",
				params = {
