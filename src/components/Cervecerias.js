...
export const Cervecerias = () => {
	...
	useEffect(() => {
		const fetchCervecerias = async () => {
		   	const response = await fetch('https://aw2022final.herokuapp.com/api/cervecerias'),
	...
	useEffect(() => {
		const fetchCervecerias = async () => {
			const response = await fetch("https://aw2022final.herokuapp.com/api/cervecerias?provincia_id="+provincia_id),
				data = await response.json()
	...
	useEffect(() => {
		const fetchCervecerias = async () => {
			const response = await fetch("https://aw2022final.herokuapp.com/api/cervecerias?localidad_id="+localidad_id),
				data = await response.json()
